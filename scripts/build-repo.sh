...
echo ""
echo "Paste this into manifest-catalog.json (replace sourceUrl with your zip download URL):"
echo "  {"
echo "    \"version\": \"$VERSION\","
echo "    \"changelog\": \"See https://github.com/bestopensors/JF-plugin/releases\","
echo "    \"targetAbi\": \"10.11.0.0\","
echo "    \"sourceUrl\": \"https://github.com/bestopensors/JF-plugin/releases/download/v$VERSION/$ZIP_NAME\","
echo "    \"checksum\": \"$HASH\","
